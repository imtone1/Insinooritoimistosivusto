  ...
  return (
    <Box className="boxit" sx={{ paddingBottom:0 }}>
      ...
      <Stack direction={'column'} sx={{ maxWidth:950, margin:'auto', gap:3, padding:3, paddingTop:3 }}>
        ...
        <Lupaus teksti={'Toimintamme on läpinäkyvää ja avointa. Näet kaiken dokumentaation kätevästi millä tahansa verkkolaitteella pilvipohjaisen modernin ohjelmiston avulla.'} otsikko1={'Läpi'} otsikko2={'näkyvyys'}/>
