...
const Palvelupolku = () => {
  return (
    ...
    <Polkuitem kuva={meeting} numero={'1.'} otsikko={'Projektipalaveri'} teksti={'Aloitamme aina projektipalaverilla. Istumme alas asiakkaan kanssa ja kuuntelemme tarkasti heidän ajatuksiaan käyttötarkoituksesta rakennukselle. Haluamme ymmärtää, millaisia tavoitteita heillä on ja mitä he haluavat saavuttaa.'}/>
    <Polkuitemoik kuva={doc} numero={'2.'} otsikko={'Luonnossuunnitelma'} teksti={'Projektipalaverin pohjalta laadimme luonnossuunnitelmia, jotka esittelemme asiakkaalle. Tämä vaihe on erittäin tärkeä, koska haluamme varmistaa, että suunnitelmat vastaavat asiakkaan toiveita ja tarpeita. Keräämme palautetta ja kuuntelemme huolellisesti, jos heillä on muutostoiveita.'}/>
    <Polkuitem kuva={geardoc} numero={'3.'} otsikko={'Toteutussuunnitelma'} teksti={'Kun rakennusvalvonta on laittanut leimat suunnitelmiin, voidaan aloittaa työt. On muistettava, että ennen töiden aloitusta, kun kyseessä on rakennuslupa, LVI-töille on oltava KVV/IV-työnjohtaja. Tarjoamme tämänkin palvelun.'}/>
    <Polkuitemoik kuva={building} numero={'4.'} otsikko={'Rakennusvalvonta'} teksti={'Kun rakennusvalvonta on laittanut leimat suunnitelmiin, voidaan aloittaa työt. On muistettava, että ennen töiden aloitusta, kun kyseessä on rakennuslupa, LVI-töille on oltava KVV/IV-työnjohtaja. Tarjoamme tämänkin palvelun.'}/>
    <Polkuitem kuva={gearapp} numero={'5.'} otsikko={'Työ etenee'} teksti={'Työn sujuvoimisesta raportoidaan asiakkaan toiveen mukaisesti sähköpostitse ja/tai ohjelmiston kautta. Ohejlmiston hyvänä puolena on, että kaikki dokumentaatio säilyy yhdessä paikassa eikä ole huolta, että jokin tärkeä dokumentti häviää sähköpostitulvaan.  '}/>
